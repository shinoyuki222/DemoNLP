...
def save_dataset(dataset, save_dir):
    ...
    # Export the dataset
    with open(os.path.join(save_dir, 'sentences.txt'), 'w', encoding="utf8") as file_sentences, \
        open(os.path.join(save_dir, 'tags.txt'), 'w', encoding="utf8") as file_tags:
...
def build_tags(data_dir, tags_file):
    ...
    for data_type in data_types:
        ...
        with open(tags_path, 'r', encoding="utf8") as file:
            for line in file:
