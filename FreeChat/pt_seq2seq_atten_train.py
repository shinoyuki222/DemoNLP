...
'''
https://pytorch.org/tutorials/beginner/chatbot_tutorial.html#load-preprocess-data
...
class Voc:
    def __init__(self, name):
        ...
        self.word2index = {}
        self.word2count = {}
        self.index2word = {PAD_token: "PAD", SOS_token: "SOS", EOS_token: "EOS", OOV_token: "UNK"}
...
def readVocs(datafile, corpus_name):
    ...
    pairs = [[text_process(s) for s in l.split('|')] for l in lines]
    voc = Voc(corpus_name)
    return voc, pairs
...
if __name__ == '__main__':
	...
	datafile = corpus
	print("corpus_name: {0}, corpus = {1}, datafile = {2}".format(corpus_name, corpus, datafile))
	if args.load_model:
	...
	if not(args.skip_train):
		print("========================")
		print("Train mode on\n========================")
		print("attn_model: {0}\nhidden_size: {1}\nencoder_n_layers: {2}\ndecoder_n_layers: {3}\ndropout: {4}\nbatch_size: {5}\nn_iteration: {6}\nsave_every: {7}\n".format(args.attn_model,args.hidden_size,args.encoder_n_layers,args.decoder_n_layers,args.dropout,args.batch_size,args.n_iteration,args.save_every))
		print("========================")
	if not(args.skip_evaluate):
		print("Evaluate mode on")
		print("========================")
